...
<p align="center">
  <img src="assets/screenshot.png" alt="面板预览" width="100%">
</p>
...
- **实时爆发榜(扫描后自动追加)**:每次扫描完成后,自动对星速最高的 12 个候选拉取真实 star 时间戳,算出**当前实时星速**(最新 ~100 颗 star 的真实速率),能识别"此刻正在爆"vs"已经降温"——这是平均星速看不出来的。结果展示为独立榜单,并把 🟢实时 标签打回赛道列表里的同名卡片。注:超 4 万星的仓库 GitHub 翻页封顶,只能取近似值(界面会标注 🟢实时 / ⚪近似)
...
- **🟢 实时 N/天**:扫描完自动追加的当前实时星速(最新 ~100 颗 star 算出),「此刻」涨得快不快看这个
